    ...
    for episode_id in episode_ids:
        ...
        if len(Ls) > 0:
            ...
            if not normalize_reward:
                ...
                rewards_Alice = np.mean(
                    [
                        -ls * 1.0 / time_limit + sb
                        for ls, sb in zip(L_A_seeds, S_A_seeds)
                    ]
                )
                SWSs.append(
                    np.mean([-ls * 1.0 / time_limit + sb for ls, sb in zip(Ls, Ss)])
...
def main(cfg: DictConfig):
    curr_dir = "/data/vision/torralba/frames/data_acquisition/SyntheticStories/online_wah/agent_preferences/"
    with open(f"{curr_dir}/analysis/final_res/failues_multi_action_new.pkl", "rb") as f:
        failures = pkl.load(f)
    config = cfg
    print("Config")
    ...
    tshu_dirk = "/data/vision/torralba/frames/data_acquisition/SyntheticStories/agent_preferences/tshu/agent_preferences/results/results_smallset_help"
    ...
    xavi_dirk = "/data/vision/torralba/frames/data_acquisition/SyntheticStories/online_wah/agent_preferences/results/results_smallset_help_diffK"
    ...
    cachedirs = [
        ...
        (
            "K1",
            f"{tshu_dirk}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_K1_1_1.0_1.0_5.0",
        ),
        (
            "K5",
            f"{tshu_dirk}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_K5_5_1.0_1.0_5.0",
        ),
        (
            "K10",
            f"{tshu_dirk}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_K10_10_1.0_1.0_5.0",
        ),
        (
            "K15",
            f"{tshu_dirk}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_K15_15_1.0_1.0_5.0",
        ),
        (
            "K20",
            f"{tshu_dirk}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_K20_20_1.0_1.0_5.0",
        ),
        (
            "K25",
            f"{tshu_dirk}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_K25_25_1.0_1.0_5.0",
        ),
    ]
    old = """
    cachedirs = [
                 ...
                 ("Ours", f"{xavi_dir}/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_20_1.0_1.0_5.0"),
                 ("Random Goal WAH", f"{xavi_dir}/helping_random_goal_wah_fast"),
                 ("1 Goal Reduced", f"{xavi_dir}/helping_states_fastwalk_r15_1_5_ip0_detfull_encoder_task_graph_1_1.0_1.0_5.0"),
                 ("Ours Recuded", f"{xavi_dir}/helping_states_fastwalk_r15_1_5_ip1_detfull_encoder_task_graph_20_1.0_1.0_5.0"),
                 ("Empowerment", f"{tshu_dir}/outputs/helping_empowerment_fastwalk_r15_1_3_ip0_uniform_20_1.0_1.0_5.0"),
                 ("ActionFreq", f"{tshu_dir}/outputs/helping_action_freq_fastwalk_r15_1_3_ip1_detfull_encoder_task_graph_20_1.0_1.0_5.0")

                 ]
                 """
    # cachedirs = [cachedirs[it] for it in [8,9]]
    for name_exp, cachedir in cachedirs:

        failures_exp = [failure[1] for failure in failures if failure[0] == name_exp]
        ...
        with open(f"{get_original_cwd()}/results_eval_helping_Ks.pik", "wb+") as f:
            pkl.dump(results, f)
