...
def main(cfg: DictConfig):
    ...
    cachedir = "/data/vision/torralba/frames/data_acquisition/SyntheticStories/agent_preferences/tshu/agent_preferences/results/results_smallset_help_diffK/helping_states_fastwalk_r15_0_5_ip1_detfull_alldata_25_1.0_1.0_5.0"
