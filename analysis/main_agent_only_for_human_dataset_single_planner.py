...
def main(cfg: DictConfig):
    ...
    args.dataset_path = f"/data/vision/torralba/frames/data_acquisition/SyntheticStories/agent_preferences/tshu/agent_preferences/dataset/structured_agent/train_env_task_set_10_full_task.setup_table_apts.0,1,2,4,5.pik"
    # args.dataset_path = './dataset/train_env_task_set_20_full_reduced_tasks_single.pik'

    cachedir = (
        f"{get_original_cwd()}/outputs/main_agent_only_human_dataset_single_planner"
    )
