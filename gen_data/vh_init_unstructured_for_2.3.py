...
parser.add_argument(
    "--exec_file",
    type=str,
    default="/data/vision/torralba/frames/data_acquisition/SyntheticStories/website/release/simulator/v2.0/v2.3.0/aviv/linux_exec.v2.3.0.x86_64",
...
if __name__ == "__main__":
    ...
    pickle.dump(
        env_task_set,
        open(
            f"{curr_dir}/../dataset/unstructured_single_agent/{args.split}_env_task_set_{args.num_per_apartment}_{args.mode}_task.{args.task}_apts.{args.apt_str}.pik",
            "wb",
        ),
    )
